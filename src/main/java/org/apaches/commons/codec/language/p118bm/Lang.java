...
/* renamed from: org.apaches.commons.codec.language.bm.Lang */
public class Lang {
    ...
    /* renamed from: org.apaches.commons.codec.language.bm.Lang$LangRule */
    private static final class LangRule {
        ...
        /* synthetic */ LangRule(Pattern pattern2, Set set, boolean z, LangRule langRule) {
            this(pattern2, set, z);
        }
                    ...
                    try {
                        ...
                        if (z) {
                            ...
                            if (trim.length() != 0) {
                                ...
                                if (split.length == 3) {
                                    arrayList.add(new LangRule(Pattern.compile(split[0]), new HashSet(Arrays.asList(split[1].split("\\+"))), split[2].equals("true"), (LangRule) null));
                                } else {
