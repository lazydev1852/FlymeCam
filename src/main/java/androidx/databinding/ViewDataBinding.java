...
import androidx.databinding.library.C0207R;
...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    public void setRootTag(View view) {
        view.setTag(C0207R.C0208id.dataBinding, this);
    }

    /* access modifiers changed from: protected */
    public void setRootTag(View[] viewArr) {
        for (View tag : viewArr) {
            tag.setTag(C0207R.C0208id.dataBinding, this);
        }
    }
    ...
    static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0207R.C0208id.dataBinding);
        }
        return null;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0029, code lost:
        if (r2.mLifecycleOwner.getLifecycle().getCurrentState().isAtLeast(androidx.lifecycle.Lifecycle.State.STARTED) != false) goto L_0x002c;
     */
    ...
    private static void mapBindings(androidx.databinding.DataBindingComponent r15, android.view.View r16, java.lang.Object[] r17, androidx.databinding.ViewDataBinding.IncludedLayouts r18, android.util.SparseIntArray r19, boolean r20) {
        ...
        L_0x008c:
            ...
            androidx.databinding.ViewDataBinding r3 = androidx.databinding.DataBindingUtil.bind((androidx.databinding.DataBindingComponent) r15, (android.view.View) r2, (int) r3)
            r17[r4] = r3
            r9 = r0
            r14 = r1
            goto L_0x0100
        ...
        L_0x00e2:
            ...
            goto L_0x00e2
        L_0x00f0:
            androidx.databinding.ViewDataBinding r3 = androidx.databinding.DataBindingUtil.bind((androidx.databinding.DataBindingComponent) r15, (android.view.View[]) r14, (int) r3)
            r17[r4] = r3
            int r5 = r5 + -1
            int r0 = r0 + r5
            r9 = r0
