...
public final class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = 0, mo109to = 255) int i, @IntRange(from = 0, mo109to = 255) int i2, @IntRange(from = 0, mo109to = 255) int i3, @NonNull float[] fArr) {
        float f;
        float f2;
    ...
    public static void RGBToLAB(@IntRange(from = 0, mo109to = 255) int i, @IntRange(from = 0, mo109to = 255) int i2, @IntRange(from = 0, mo109to = 255) int i3, @NonNull double[] dArr) {
    ...
    public static void LABToXYZ(@FloatRange(from = 0.0d, mo103to = 100.0d) double d, @FloatRange(from = -128.0d, mo103to = 127.0d) double d2, @FloatRange(from = -128.0d, mo103to = 127.0d) double d3, @NonNull double[] dArr) {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, mo103to = 100.0d) double d, @FloatRange(from = -128.0d, mo103to = 127.0d) double d2, @FloatRange(from = -128.0d, mo103to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
