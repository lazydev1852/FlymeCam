...
public final class Palette {
    ...
    static final C0288Filter DEFAULT_FILTER = new C0288Filter() {
    ...
    /* renamed from: androidx.palette.graphics.Palette$Filter */
    public interface C0288Filter {
    ...
    public static final class Builder {
        ...
        private final List<C0288Filter> mFilters = new ArrayList();
        ...
        @NonNull
        public Builder addFilter(C0288Filter filter) {
            if (filter != null) {
        ...
        @NonNull
        public Builder setRegion(@C0010Px int i, @C0010Px int i2, @C0010Px int i3, @C0010Px int i4) {
        ...
        public Palette generate() {
            ...
            if (this.mBitmap != null) {
                ...
                ColorCutQuantizer colorCutQuantizer = new ColorCutQuantizer(getPixelsFromBitmap(scaleBitmapDown), this.mMaxColors, this.mFilters.isEmpty() ? null : (C0288Filter[]) this.mFilters.toArray(new C0288Filter[this.mFilters.size()]));
