...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VGroup extends VObject {
        ...
        private void updateStateFromTypedArray(TypedArray typedArray, XmlPullParser xmlPullParser) {
            ...
            this.mRotate = TypedArrayUtils.getNamedFloat(typedArray, xmlPullParser, BaseParameters.KEY_PICTURE_ROTATION, 5, this.mRotate);
    ...
    private static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            while (i < pathDataNodeArr.length) {
                ...
                String str2 = str + pathDataNodeArr[i].mType + SystemInfoUtil.COLON;
                for (int i2 = 0; i2 < fArr.length; i2++) {
                    str2 = str2 + fArr[i2] + SystemInfoUtil.COMMA;
                }
                i++;
                str = str2;
            }
