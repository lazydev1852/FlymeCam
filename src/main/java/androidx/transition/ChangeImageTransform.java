    ...
    static /* synthetic */ class C03733 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C03733.<clinit>():void");
        }
    }

    private static Matrix copyImageMatrix(ImageView imageView) {
        switch (C03733.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:
