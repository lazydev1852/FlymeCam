...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder) {
        this(context, menuBuilder, (View) null, false, C0011R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view) {
        this(context, menuBuilder, view, false, C0011R.attr.popupMenuStyle, 0);
    }
    ...
    private androidx.appcompat.view.menu.MenuPopup createPopup() {
        ...
        L_0x0020:
            ...
            int r2 = androidx.appcompat.C0011R.dimen.abc_cascading_menus_min_smallest_width
