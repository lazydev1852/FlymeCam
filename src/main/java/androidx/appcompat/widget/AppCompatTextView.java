...
public class AppCompatTextView extends TextView implements TintableBackgroundView, AutoSizeableTextView {
    ...
    public void setFirstBaselineToTopHeight(@C0010Px @IntRange(from = 0) int i) {
    ...
    public void setLastBaselineToBottomHeight(@C0010Px @IntRange(from = 0) int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    public void setLineHeight(@C0010Px @IntRange(from = 0) int i) {
