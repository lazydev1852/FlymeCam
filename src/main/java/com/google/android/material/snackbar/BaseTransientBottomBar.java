...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C0934R.attr.snackbarStyle};
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0934R.layout.mtrl_layout_snackbar : C0934R.layout.design_layout_snackbar;
    }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(C0934R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) obtainStyledAttributes.getDimensionPixelSize(C0934R.styleable.SnackbarLayout_elevation, 0));
            }
            obtainStyledAttributes.recycle();
