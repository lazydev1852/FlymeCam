...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0934R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0934R.C0935drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0934R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0934R.C0936id.icon);
        this.smallLabel = (TextView) findViewById(C0934R.C0936id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0934R.C0936id.largeLabel);
