...
public final class ThemeEnforcement {
    private static final int[] APPCOMPAT_CHECK_ATTRS = {C0934R.attr.colorPrimary};
    private static final String APPCOMPAT_THEME_NAME = "Theme.AppCompat";
    private static final int[] MATERIAL_CHECK_ATTRS = {C0934R.attr.colorSecondary};
    ...
    private static void checkCompatibleTheme(Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0934R.styleable.ThemeEnforcement, i, i2);
        boolean z = obtainStyledAttributes.getBoolean(C0934R.styleable.ThemeEnforcement_enforceMaterialTheme, false);
    ...
    private static void checkTextAppearance(Context context, AttributeSet attributeSet, @StyleableRes int[] iArr, @AttrRes int i, @StyleRes int i2, @StyleableRes int... iArr2) {
        boolean z;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0934R.styleable.ThemeEnforcement, i, i2);
        if (!obtainStyledAttributes.getBoolean(C0934R.styleable.ThemeEnforcement_enforceTextAppearance, false)) {
            obtainStyledAttributes.recycle();
            return;
        }
        if (iArr2 == null || iArr2.length == 0) {
            z = obtainStyledAttributes.getResourceId(C0934R.styleable.ThemeEnforcement_android_textAppearance, -1) != -1;
        } else {
