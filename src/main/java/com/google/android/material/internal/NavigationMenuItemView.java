...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0934R.layout.design_navigation_menu_item, this, true);
        this.iconSize = context.getResources().getDimensionPixelSize(C0934R.dimen.design_navigation_icon_size);
        this.textView = (CheckedTextView) findViewById(C0934R.C0936id.design_menu_item_text);
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0934R.C0936id.design_menu_item_action_area_stub)).inflate();
            }
            this.actionArea.removeAllViews();
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0011R.attr.colorControlHighlight, typedValue, true)) {
            return null;
        }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                this.emptyDrawable = ResourcesCompat.getDrawable(getResources(), C0934R.C0935drawable.navigation_empty_icon, getContext().getTheme());
                if (this.emptyDrawable != null) {
