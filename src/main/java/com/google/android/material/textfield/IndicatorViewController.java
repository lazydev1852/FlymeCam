...
public final class IndicatorViewController {
    ...
    private final float captionTranslationYPx = ((float) this.context.getResources().getDimensionPixelSize(C0934R.dimen.design_textinput_caption_translate_y));
    ...
    public void setErrorEnabled(boolean z) {
        if (this.errorEnabled != z) {
            ...
            if (z) {
                ...
                this.errorView.setId(C0934R.C0936id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            ...
            if (z) {
                ...
                this.helperTextView.setId(C0934R.C0936id.textinput_helper_text);
                if (this.typeface != null) {
