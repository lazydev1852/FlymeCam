...
public final class PlanarYUVLuminanceSource extends LuminanceSource {
    ...
    private boolean mScanPortrait = false;
    ...
    public void setScanPortrait(boolean z) {
        this.mScanPortrait = z;
    }
    ...
    public byte[] getRow(int i, byte[] bArr) {
        ...
        if (this.mScanPortrait) {
            for (int i2 = 0; i2 < getHeight(); i2++) {
                bArr[i2] = this.yuvData[((this.top + i2) * this.dataWidth) + this.left + i];
            }
        } else {
