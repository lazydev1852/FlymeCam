...
public abstract class AbstractDateDeserializer extends ContextObjectDeserializer implements ObjectDeserializer {
    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj, String str, int i) {
        ...
        if (jSONLexer.token() == 2) {
            obj3 = Long.valueOf(jSONLexer.longValue());
            ...
            if (str != null) {
                ...
                try {
                    obj3 = simpleDateFormat.parse(stringVal);
                } catch (ParseException unused2) {
                    if (str.equals("yyyy-MM-dd'T'HH:mm:ss.SSS") && stringVal.length() == 19) {
                        try {
                            obj3 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss").parse(stringVal);
        ...
        return cast(defaultJSONParser, type, obj, obj3);
    }
}
