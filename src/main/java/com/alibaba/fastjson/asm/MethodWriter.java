...
public class MethodWriter implements MethodVisitor {
    ...
    public void visitTypeInsn(int i, String str) {
        this.code.put12(i, this.f132cw.newClassItem(str).index);
    }

    public void visitFieldInsn(int i, String str, String str2, String str3) {
        this.code.put12(i, this.f132cw.newFieldItem(str, str2, str3).index);
    }

    public void visitMethodInsn(int i, String str, String str2, String str3) {
        boolean z = i == 185;
        Item newMethodItem = this.f132cw.newMethodItem(str, str2, str3, z);
    ...
    public void visitLdcInsn(Object obj) {
        Item newConstItem = this.f132cw.newConstItem(obj);
    ...
    public final int getSize() {
        ...
        this.f132cw.newUTF8("Exceptions");
    ...
    public final void put(ByteVector byteVector) {
        ...
        if (this.code.length > 0) {
            byteVector.putShort(this.f132cw.newUTF8("Code")).putInt(this.code.length + 12 + 0);
        ...
        if (this.exceptionCount > 0) {
            byteVector.putShort(this.f132cw.newUTF8("Exceptions")).putInt((this.exceptionCount * 2) + 2);
