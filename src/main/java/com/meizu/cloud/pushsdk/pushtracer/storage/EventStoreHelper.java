...
public class EventStoreHelper extends SQLiteOpenHelper {
    ...
    private static final String TAG = "com.meizu.cloud.pushsdk.pushtracer.storage.EventStoreHelper";
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        String str = TAG;
        Logger.m4854d(str, "Upgrading database from version " + i + " to " + i2 + ". Destroying old data now..", new Object[0]);
