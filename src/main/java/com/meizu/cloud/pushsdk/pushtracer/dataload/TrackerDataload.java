...
public class TrackerDataload implements DataLoad {
    ...
    public void add(String str, String str2) {
        if (str2 == null || str2.isEmpty()) {
            ...
            Logger.m4856i(str3, "The keys value is empty, returning without adding key: " + str, new Object[0]);
            return;
        }
    ...
    public void add(String str, Object obj) {
        if (obj == null) {
            ...
            Logger.m4856i(str2, "The keys value is empty, returning without adding key: " + str, new Object[0]);
            return;
        }
    ...
    public void addMap(Map<String, Object> map) {
        if (map == null) {
            Logger.m4856i(this.TAG, "Map passed in is null, returning without adding map.", new Object[0]);
        } else {
    ...
    public void addMap(Map map, Boolean bool, String str, String str2) {
        if (map == null) {
            Logger.m4856i(this.TAG, "Map passed in is null, returning nothing.", new Object[0]);
            return;
        }
        String jSONObject = Util.mapToJSONObject(map).toString();
        String str3 = this.TAG;
        Logger.m4856i(str3, "Adding new map: " + jSONObject, new Object[0]);
