...
public class SelfDescribingJson implements DataLoad {
    ...
    public void add(String str, String str2) {
        Logger.m4856i(this.TAG, "Payload: add(String, String) method called - Doing nothing.", new Object[0]);
    }

    @Deprecated
    public void add(String str, Object obj) {
        Logger.m4856i(this.TAG, "Payload: add(String, Object) method called - Doing nothing.", new Object[0]);
    }

    @Deprecated
    public void addMap(Map<String, Object> map) {
        Logger.m4856i(this.TAG, "Payload: addMap(Map<String, Object>) method called - Doing nothing.", new Object[0]);
    }

    @Deprecated
    public void addMap(Map map, Boolean bool, String str, String str2) {
        Logger.m4856i(this.TAG, "Payload: addMap(Map, Boolean, String, String) method called - Doing nothing.", new Object[0]);
    }
