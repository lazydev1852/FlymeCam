...
public class NotificationState implements Parcelable {
    public static final Parcelable.Creator<NotificationState> CREATOR = new Parcelable.Creator<NotificationState>() {
    ...
    public NotificationState(MessageV3 messageV32) {
        this.messageV3 = messageV32;
    }
    ...
    public void setMessageV3(MessageV3 messageV32) {
        this.messageV3 = messageV32;
    }
