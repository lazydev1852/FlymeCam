...
public class UploadLogMessage implements Parcelable {
    public static final Parcelable.Creator<UploadLogMessage> CREATOR = new Parcelable.Creator<UploadLogMessage>() {
    ...
    public UploadLogMessage(String str, String str2, String str3, String str4) {
        ...
        try {
            ...
            DebugLogger.m4828e(TAG, "parse upload message error " + e.getMessage());
        }
    ...
    protected UploadLogMessage(Parcel parcel) {
        ...
        this.wifiUpload = parcel.readByte() != 0;
    ...
    public void setControlMessage(ControlMessage controlMessage2) {
        this.controlMessage = controlMessage2;
    }

    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeInt(this.maxSize);
        parcel.writeByte(this.wifiUpload ? (byte) 1 : 0);
