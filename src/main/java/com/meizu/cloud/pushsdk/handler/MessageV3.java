...
public class MessageV3 implements Parcelable {
    ...
    public static MessageV3 parse(String str, String str2, String str3, MPushMessage mPushMessage) {
        DebugLogger.m4828e(TAG, "V2 message " + mPushMessage);
        ...
        String jSONObject = Util.mapToJSONObject(mPushMessage.getExtra()).toString();
        DebugLogger.m4828e(TAG, "MessageV2 extra json is " + jSONObject);
        if (!TextUtils.isEmpty(jSONObject)) {
            messageV3.setNotificationMessage(jSONObject);
        }
        DebugLogger.m4829i(TAG, "parase V2 message to V3 message " + messageV3);
        return messageV3;
    }
        ...
        try {
            ...
            if (!jSONObject.isNull(PushConstants.EXTRA)) {
                ...
                if (!jSONObject2.isNull("task_id") && TextUtils.isEmpty(str3)) {
                    DebugLogger.m4828e(TAG, "Flyme 4 notification message by through message or taskId is null");
            ...
            DebugLogger.m4828e(TAG, "parse message error " + e.getMessage());
        }
        return messageV3;
    }
