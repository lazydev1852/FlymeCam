...
public final class Headers {
    ...
    /* renamed from: of */
    public static Headers m4851of(String... strArr) {
    ...
    /* renamed from: of */
    public static Headers m4850of(Map<String, String> map) {
        if (map != null) {
    ...
    public static final class Builder {
        ...
        public Builder addLenient(String str) {
            int indexOf = str.indexOf(SystemInfoUtil.COLON, 1);
            if (indexOf != -1) {
                return addLenient(str.substring(0, indexOf), str.substring(indexOf + 1));
            }
            if (str.startsWith(SystemInfoUtil.COLON)) {
        ...
        public Builder add(String str) {
            int indexOf = str.indexOf(SystemInfoUtil.COLON);
            if (indexOf != -1) {
