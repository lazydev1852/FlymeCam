...
public final class Buffer implements BufferedSink, BufferedSource, Cloneable {
    ...
    public long readDecimalLong() {
        /*
            ...
            r6 = 0
        L_0x0010:
            com.meizu.cloud.pushsdk.networking.okio.Segment r10 = r0.head
            byte[] r11 = r10.data
            int r12 = r10.pos
            int r13 = r10.limit
        L_0x0018:
        ...
        L_0x0036:
            ...
            goto L_0x0074
        L_0x003d:
            com.meizu.cloud.pushsdk.networking.okio.Buffer r1 = new com.meizu.cloud.pushsdk.networking.okio.Buffer
            r1.<init>()
            com.meizu.cloud.pushsdk.networking.okio.Buffer r1 = r1.writeDecimalLong((long) r3)
            com.meizu.cloud.pushsdk.networking.okio.Buffer r1 = r1.writeByte((int) r15)
        ...
        L_0x0098:
            ...
            com.meizu.cloud.pushsdk.networking.okio.Segment r1 = r10.pop()
            r0.head = r1
        ...
        L_0x00a6:
            ...
            com.meizu.cloud.pushsdk.networking.okio.Segment r1 = r0.head
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0094, code lost:
        r14.head = r6.pop();
        com.meizu.cloud.pushsdk.networking.okio.SegmentPool.recycle(r6);
     */
    ...
    public long readHexadecimalUnsignedLong() {
        /*
            ...
            r1 = 0
        L_0x000b:
            com.meizu.cloud.pushsdk.networking.okio.Segment r6 = r14.head
            byte[] r7 = r6.data
            int r8 = r6.pos
            int r9 = r6.limit
        L_0x0013:
        ...
        L_0x003b:
            ...
            goto L_0x0013
        L_0x004b:
            com.meizu.cloud.pushsdk.networking.okio.Buffer r0 = new com.meizu.cloud.pushsdk.networking.okio.Buffer
            r0.<init>()
            com.meizu.cloud.pushsdk.networking.okio.Buffer r0 = r0.writeHexadecimalUnsignedLong((long) r4)
            com.meizu.cloud.pushsdk.networking.okio.Buffer r0 = r0.writeByte((int) r10)
            java.lang.NumberFormatException r1 = new java.lang.NumberFormatException
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            r2.<init>()
        ...
        L_0x0092:
            if (r8 != r9) goto L_0x009e
            com.meizu.cloud.pushsdk.networking.okio.Segment r7 = r6.pop()
            r14.head = r7
            com.meizu.cloud.pushsdk.networking.okio.SegmentPool.recycle(r6)
            goto L_0x00a0
        L_0x009e:
    ...
    public Segment writableSegment(int i) {
        if (i < 1 || i > 2048) {
            ...
            return (segment4.limit + i > 2048 || !segment4.owner) ? segment4.push(SegmentPool.take()) : segment4;
        }
    }
        ...
        try {
            ...
            while (true) {
                ...
                if (segment != this.head) {
                    ...
                    return String.format("Buffer[size=%s md5=%s]", new Object[]{Long.valueOf(this.size), ByteString.m4852of(instance.digest()).hex()});
                }
            }
