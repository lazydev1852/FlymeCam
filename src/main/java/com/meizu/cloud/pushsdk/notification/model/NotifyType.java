    ...
    public static NotifyType parse(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                DebugLogger.m4828e("notify_type", "parse json string error " + e.getMessage());
            }
    ...
    public static NotifyType parse(JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            try {
                ...
                DebugLogger.m4828e("notify_type", "parse json obj error " + e.getMessage());
            }
        } else {
            DebugLogger.m4828e("notify_type", "no such tag notify_type");
        }
        return notifyType;
    }
