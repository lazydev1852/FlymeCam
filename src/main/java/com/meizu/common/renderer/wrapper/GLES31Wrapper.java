...
public class GLES31Wrapper {
    ...
    static {
        try {
            ...
            Log.e("glrenderer", "Exception: " + e.getMessage());
        }
    }

    public static void glBindImageTexture(int i, int i2, int i3, boolean z, int i4, int i5, int i6) {
        try {
            sMethod_glBindImageTexture.invoke((Object) null, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Boolean.valueOf(z), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6)});
            ShaderUtils.m5097a();
        } catch (Exception e) {
            Log.e("glrenderer", "Exception glBindImageTexture: " + e.getMessage());
        }
    }

    public static void glDispatchCompute(int i, int i2, int i3) {
        try {
            sMethod_glDispatchCompute.invoke((Object) null, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
            ShaderUtils.m5097a();
        } catch (Exception e) {
            Log.e("glrenderer", "Exception glDispatchCompute: " + e.getMessage());
        }
    }

    public static void glMemoryBarrier(int i) {
        try {
            sMethod_glMemoryBarrier.invoke((Object) null, new Object[]{Integer.valueOf(i)});
            ShaderUtils.m5097a();
        } catch (Exception e) {
            Log.e("glrenderer", "Exception glMemoryBarrier: " + e.getMessage());
        }
    }

    public static void glTexStorage2D(int i, int i2, int i3, int i4, int i5) {
        try {
            sMethod_glTexStorage2D.invoke((Object) null, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5)});
            ShaderUtils.m5097a();
        } catch (Exception e) {
            Log.e("glrenderer", "Exception glTexStorage2D: " + e.getMessage());
        }
    }
}
