...
public class HDStickerGlobalParams {
    public static ChangeQuickRedirect changeQuickRedirect;
    private static HDStickerGlobalParams instance;
    ...
    public static HDStickerGlobalParams getInstance() {
        PatchProxyResult proxy = PatchProxy.proxy(new Object[0], (Object) null, changeQuickRedirect, true, 9366, new Class[0], HDStickerGlobalParams.class);
        if (proxy.isSupported) {
            return (HDStickerGlobalParams) proxy.result;
        }
        if (instance == null) {
            synchronized (HDStickerGlobalParams.class) {
                if (instance == null) {
                    instance = new HDStickerGlobalParams();
                }
            }
        }
        return instance;
    ...
    public void updateParameters(FaceArcsoft.Face[] faceArr) {
        if (!PatchProxy.proxy(new Object[]{faceArr}, this, changeQuickRedirect, false, 9367, new Class[]{FaceArcsoft.Face[].class}, Void.TYPE).isSupported) {
