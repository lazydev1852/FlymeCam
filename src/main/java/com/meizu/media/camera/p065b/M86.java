...
/* renamed from: com.meizu.media.camera.b.ad */
public class M86 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8001a;

    /* renamed from: a */
    public static void m8483a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8001a, true, 3729, new Class[0], Void.TYPE).isSupported) {
            ...
            f14037g = DeviceHelper.SHUTTER_SPEED.SP420S;
