...
/* renamed from: com.meizu.media.camera.b.ah */
public class MA02 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8005a;

    /* renamed from: a */
    public static void m8487a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8005a, true, 3733, new Class[0], Void.TYPE).isSupported) {
