...
/* renamed from: com.meizu.media.camera.b.j */
public class M1813 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8014a;

    /* renamed from: a */
    public static void m8496a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8014a, true, 3709, new Class[0], Void.TYPE).isSupported) {
            ...
            f13856aI = true;
            f13857aJ = true;
            f13858aK = DeviceHelper.STEREO_TYPE.TYPE_PROCESS_IN_HAL;
            f13859aL = false;
            f13860aM = true;
            f13861aN = false;
            f13862aO = false;
