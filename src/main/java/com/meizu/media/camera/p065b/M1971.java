...
/* renamed from: com.meizu.media.camera.b.y */
public class M1971 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8029a;

    /* renamed from: a */
    public static void m8511a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8029a, true, 3724, new Class[0], Void.TYPE).isSupported) {
            ...
            f13889ap = true;
            f13890aq = true;
            f13891ar = DeviceHelper.FRONT_HDR_HAL_CONFIG.SYSTEM_PROPERTIES;
            f13892as = false;
            f13893at = true;
            f13894au = false;
            f13895av = true;
