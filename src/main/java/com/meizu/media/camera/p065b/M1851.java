...
/* renamed from: com.meizu.media.camera.b.m */
public class M1851 extends DeviceHelper {
    ...
    public static void m8499a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8017a, true, 3712, new Class[0], Void.TYPE).isSupported) {
            ...
            f13873aZ = false;
            f13927ba = false;
            f13931be = new int[]{114, 123, Opcodes.LCMP, 170, 186, 195};
