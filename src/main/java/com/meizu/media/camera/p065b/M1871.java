...
/* renamed from: com.meizu.media.camera.b.o */
public class M1871 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8019a;

    /* renamed from: a */
    public static void m8501a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8019a, true, 3714, new Class[0], Void.TYPE).isSupported) {
            f14006d = new CameraModeType.ModeType[]{CameraModeType.ModeType.AUTO, CameraModeType.ModeType.MANUAL, CameraModeType.ModeType.VIDEO, CameraModeType.ModeType.PANORAMA, CameraModeType.ModeType.SLOWMOTION, CameraModeType.ModeType.BARCODE, CameraModeType.ModeType.TIMELAPSE, CameraModeType.ModeType.SQUARE, CameraModeType.ModeType.FUNNY_SNAP, CameraModeType.ModeType.BACK_TRACE, CameraModeType.ModeType.DOCUMENT, CameraModeType.ModeType.SUPER_NIGHT, CameraModeType.ModeType.AMAZINGAR, CameraModeType.ModeType.BACK_LIGHTING};
            ...
            f13958cE = new int[]{15, 30, 10, 15, 0, 0, 0, 15};
            f13959cF = new int[]{20, 35, 13, 15, 0, 0, 0, 20};
            f13960cG = new int[]{30, 45, 15, 15, 0, 0, 0, 30};
            f13961cH = new int[]{36, 55, 18, 20, 0, 0, 0, 33};
            f13962cI = new int[]{40, 60, 25, 25, 0, 0, 0, 40};
