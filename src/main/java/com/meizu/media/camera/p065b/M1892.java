...
/* renamed from: com.meizu.media.camera.b.t */
public class M1892 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8024a;

    /* renamed from: a */
    public static void m8506a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8024a, true, 3719, new Class[0], Void.TYPE).isSupported) {
