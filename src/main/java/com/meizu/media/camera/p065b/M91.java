...
/* renamed from: com.meizu.media.camera.b.ae */
public class M91 extends DeviceHelper {
    ...
    public static void m8484a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8002a, true, 3730, new Class[0], Void.TYPE).isSupported) {
            f14006d = new CameraModeType.ModeType[]{CameraModeType.ModeType.AUTO, CameraModeType.ModeType.MANUAL, CameraModeType.ModeType.VIDEO, CameraModeType.ModeType.PANORAMA, CameraModeType.ModeType.SLOWMOTION, CameraModeType.ModeType.BARCODE, CameraModeType.ModeType.TIMELAPSE, CameraModeType.ModeType.FUNNY_SNAP, CameraModeType.ModeType.SQUARE, CameraModeType.ModeType.BACK_TRACE};
            ...
            f13935bi = false;
            f13936bj = true;
            f13937bk = DeviceHelper.EXPOSURE_STEP.STEP_NORMAL;
            f13938bl = 1;
            f13939bm = 2;
            f13940bn = 30;
            f13941bo = false;
