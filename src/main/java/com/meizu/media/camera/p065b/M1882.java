...
/* renamed from: com.meizu.media.camera.b.r */
public class M1882 extends DeviceHelper {
    ...
    public static void m8504a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8022a, true, 3717, new Class[0], Void.TYPE).isSupported) {
