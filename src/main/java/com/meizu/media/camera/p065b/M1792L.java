...
/* renamed from: com.meizu.media.camera.b.g */
public class M1792L extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8011a;

    /* renamed from: a */
    public static void m8493a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8011a, true, 3706, new Class[0], Void.TYPE).isSupported) {
            f14006d = new CameraModeType.ModeType[]{CameraModeType.ModeType.AUTO, CameraModeType.ModeType.MANUAL, CameraModeType.ModeType.PORTRAIT, CameraModeType.ModeType.VIDEO, CameraModeType.ModeType.PANORAMA, CameraModeType.ModeType.SLOWMOTION, CameraModeType.ModeType.BARCODE, CameraModeType.ModeType.TIMELAPSE, CameraModeType.ModeType.BLACK_WHITE, CameraModeType.ModeType.FUNNY_SNAP, CameraModeType.ModeType.SQUARE, CameraModeType.ModeType.BACK_TRACE, CameraModeType.ModeType.DOCUMENT, CameraModeType.ModeType.SUPER_NIGHT, CameraModeType.ModeType.AMAZINGAR, CameraModeType.ModeType.BACK_LIGHTING};
            ...
            f13856aI = true;
            f13857aJ = true;
            f13858aK = DeviceHelper.STEREO_TYPE.TYPE_PRO7SERIES;
            f13859aL = false;
            f13860aM = true;
            f13861aN = false;
            f13862aO = true;
