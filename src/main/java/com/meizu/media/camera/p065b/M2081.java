...
public class M2081 extends DeviceHelper {
    ...
    public static void m8480a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f7998a, true, 3726, new Class[0], Void.TYPE).isSupported) {
            ...
            f14019dk = DeviceHelper.EIS_SUPPORT_SCENE.WITHOUT_TELE;
