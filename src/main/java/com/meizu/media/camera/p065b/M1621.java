...
public class M1621 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8006a;

    /* renamed from: a */
    public static void m8488a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8006a, true, 3701, new Class[0], Void.TYPE).isSupported) {
