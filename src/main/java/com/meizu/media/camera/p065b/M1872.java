...
/* renamed from: com.meizu.media.camera.b.p */
public class M1872 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8020a;

    /* renamed from: a */
    public static void m8502a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8020a, true, 3715, new Class[0], Void.TYPE).isSupported) {
            ...
            f14016dh = 3840;
            f14017di = 180;
            f14018dj = DeviceHelper.EIS_TYPE.INVENSENSE;
