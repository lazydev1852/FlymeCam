...
/* renamed from: com.meizu.media.camera.b.af */
public class M95 extends DeviceHelper {
    ...
    public static void m8485a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8003a, true, 3731, new Class[0], Void.TYPE).isSupported) {
