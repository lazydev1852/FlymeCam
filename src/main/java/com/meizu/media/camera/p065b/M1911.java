...
/* renamed from: com.meizu.media.camera.b.u */
public class M1911 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8025a;

    /* renamed from: a */
    public static void m8507a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8025a, true, 3720, new Class[0], Void.TYPE).isSupported) {
            f14006d = new CameraModeType.ModeType[]{CameraModeType.ModeType.AUTO, CameraModeType.ModeType.MANUAL, CameraModeType.ModeType.PORTRAIT, CameraModeType.ModeType.VIDEO, CameraModeType.ModeType.PANORAMA, CameraModeType.ModeType.SLOWMOTION, CameraModeType.ModeType.BARCODE, CameraModeType.ModeType.TIMELAPSE, CameraModeType.ModeType.SQUARE, CameraModeType.ModeType.BACK_TRACE, CameraModeType.ModeType.DOCUMENT, CameraModeType.ModeType.AMAZINGAR};
            f14035e = new CameraModeType.ModeType[]{CameraModeType.ModeType.PORTRAIT, CameraModeType.ModeType.AUTO, CameraModeType.ModeType.VIDEO};
            ...
            f13856aI = true;
            f13857aJ = false;
            f13858aK = DeviceHelper.STEREO_TYPE.TYPE_PROCESS_IN_NORMAL_CAPTURE_FORSAMSUNG;
            f13859aL = false;
            f13860aM = true;
            f13861aN = false;
            f13862aO = false;
            ...
            f13873aZ = false;
            f13927ba = false;
            f13931be = new int[]{109, 125, Opcodes.DCMPL, Opcodes.IF_ACMPNE, Opcodes.INVOKEVIRTUAL, 190};
            f13932bf = new int[]{190, 174, 144, 120, 109, 104};
            ...
            f13922bV = 1126;
            f13923bW = MsgField.IMSG_SAVE_PICTURE;
            f13924bX = 1000;
            f13981cb = 60;
            f13982cc = 2;
            f13983cd = 5;
            ...
            f13967cN = new int[]{18, 20, 10, 15, 0, 0};
            f13968cO = new int[]{20, 25, 13, 15, 0, 0};
            f13969cP = new int[]{25, 30, 15, 15, 0, 0};
            f13970cQ = new int[]{30, 35, 20, 20, 0, 0};
            f13971cR = new int[]{35, 40, 25, 25, 0, 0};
