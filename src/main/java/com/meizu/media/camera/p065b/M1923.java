...
/* renamed from: com.meizu.media.camera.b.v */
public class M1923 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8026a;

    /* renamed from: a */
    public static void m8508a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8026a, true, 3721, new Class[0], Void.TYPE).isSupported) {
            ...
            f14020dl = new float[]{5.4f, 8.346f, 0.0f};
            f14021dm = false;
