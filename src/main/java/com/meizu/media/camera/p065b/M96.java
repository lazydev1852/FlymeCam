...
/* renamed from: com.meizu.media.camera.b.ag */
public class M96 extends DeviceHelper {

    /* renamed from: a */
    public static ChangeQuickRedirect f8004a;

    /* renamed from: a */
    public static void m8486a() {
        if (!PatchProxy.proxy(new Object[0], (Object) null, f8004a, true, 3732, new Class[0], Void.TYPE).isSupported) {
