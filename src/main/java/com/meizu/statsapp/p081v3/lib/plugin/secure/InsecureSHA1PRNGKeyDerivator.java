...
/* renamed from: com.meizu.statsapp.v3.lib.plugin.secure.InsecureSHA1PRNGKeyDerivator */
public class InsecureSHA1PRNGKeyDerivator {
    ...
    /* renamed from: H0 */
    private static final int f15992H0 = 1732584193;

    /* renamed from: H1 */
    private static final int f15993H1 = -271733879;

    /* renamed from: H2 */
    private static final int f15994H2 = -1732584194;

    /* renamed from: H3 */
    private static final int f15995H3 = 271733878;

    /* renamed from: H4 */
    private static final int f15996H4 = -1009589776;
    ...
    private InsecureSHA1PRNGKeyDerivator() {
        this.seed[82] = f15992H0;
        this.seed[83] = f15993H1;
        this.seed[84] = f15994H2;
        this.seed[85] = f15995H3;
        this.seed[86] = f15996H4;
        this.seedLength = 0;
