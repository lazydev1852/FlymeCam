...
/* renamed from: com.baidu.ar.imu.d */
public class C0773d extends C0777f {

    /* renamed from: k */
    private final Quaternion f1738k = new Quaternion();

    /* renamed from: l */
    private Quaternion f1739l = new Quaternion();

    /* renamed from: m */
    private Quaternion f1740m = new Quaternion();

    /* renamed from: n */
    private long f1741n;

    /* renamed from: o */
    private double f1742o = 0.0d;
    ...
    public C0773d(SensorManager sensorManager) {
        super(sensorManager);
    ...
    /* renamed from: a */
    private void m2025a(Quaternion quaternion) {
    ...
    /* renamed from: a */
    public static void m2026a(float[] fArr, float[] fArr2) {
        if (fArr2.length >= 4) {
            fArr[0] = fArr2[3];
        } else {
    ...
    /* renamed from: a */
    public void mo10137a() {
        if (!this.f1756g) {
            this.f1756g = true;
            System.arraycopy(this.f1754e.matrix, 0, this.f1757h.matrix, 0, this.f1754e.matrix.length);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:43:0x00be, code lost:
        r6 = (r12.f1742o * ((double) r0)) / 2.0d;
        r8 = java.lang.Math.sin(r6);
        r6 = java.lang.Math.cos(r6);
        r12.f1738k.setX((float) (((double) r2) * r8));
        r12.f1738k.setY((float) (((double) r5) * r8));
        r12.f1738k.setZ((float) (r8 * ((double) r1)));
        r12.f1738k.setW(-((float) r6));
        r12.f1738k.multiplyByQuat(r12.f1739l, r12.f1739l);
        r0 = r12.f1739l.dotProduct(r12.f1740m);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:49:0x011d, code lost:
        ...
        r12.f1739l.slerp(r12.f1740m, r0, (float) (r12.f1742o * 0.009999999776482582d));
        m2025a(r0);
        r12.f1739l.copyVec4(r0);
        r12.f1744q = 0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x0141, code lost:
        if (r12.f1744q <= 60) goto L_0x0188;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x014e, code lost:
        if (r12.f1742o >= 3.0d) goto L_0x0164;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:54:0x0150, code lost:
        ...
        m2025a(r12.f1740m);
        r12.f1739l.copyVec4(r12.f1740m);
        r12.f1744q = 0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x0164, code lost:
        com.baidu.p020ar.util.ARLog.m2695d("Rotation Vector" + java.lang.String.format("Panic reset delayed due to ongoing motion (user is still shaking the device). Gyroscope Velocity: %.2f > 3", new java.lang.Object[]{java.lang.Double.valueOf(r12.f1742o)}));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:56:0x0188, code lost:
        r12.f1741n = r13.timestamp;
     */
    ...
    public void onSensorChanged(android.hardware.SensorEvent r13) {
        ...
        L_0x0035:
            ...
            m2026a(r0, r13)
        L_0x003a:
            com.baidu.ar.arplay.representation.Quaternion r13 = r12.f1740m
            r2 = r0[r3]
            r1 = r0[r1]
            r5 = 3
            r5 = r0[r5]
            ...
            boolean r13 = r12.f1743p
            if (r13 != 0) goto L_0x0190
            com.baidu.ar.arplay.representation.Quaternion r13 = r12.f1739l
            com.baidu.ar.arplay.representation.Quaternion r0 = r12.f1740m
            r13.set(r0)
            r12.f1743p = r3
            goto L_0x0190
        L_0x0058:
        ...
        L_0x00be:
            ...
            com.baidu.ar.arplay.representation.Quaternion r0 = r12.f1738k
            ...
            r0.setW(r1)
            com.baidu.ar.arplay.representation.Quaternion r0 = r12.f1738k
            com.baidu.ar.arplay.representation.Quaternion r1 = r12.f1739l
            com.baidu.ar.arplay.representation.Quaternion r2 = r12.f1739l
            r0.multiplyByQuat(r1, r2)
            com.baidu.ar.arplay.representation.Quaternion r0 = r12.f1739l
            com.baidu.ar.arplay.representation.Quaternion r1 = r12.f1740m
        ...
        L_0x011d:
            ...
            r0.<init>()
            com.baidu.ar.arplay.representation.Quaternion r1 = r12.f1739l
            com.baidu.ar.arplay.representation.Quaternion r2 = r12.f1740m
        ...
        L_0x0190:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.p020ar.imu.C0773d.onSensorChanged(android.hardware.SensorEvent):void");
    }
}
